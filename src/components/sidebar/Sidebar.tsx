...
} from "@/stores/selectedChannels";
import {
    addUnselectedChannel,
    deleteUnselectedChannel,
} from "@/stores/unselectedChannels";
...
export default function Sidebar() {
    ...
    return (
        <div
            className={`p-6 bg-[#2D2727] text-white h-full w-[400px] fixed text-lg overflow-y-auto z-10 transition-all ${
                        ...
                        {unselectedChannels.map((channel: IChannel) => (
                            ...
                            >
                                ...
                                <button
                                    className="bg-[#F0EB8D] h-full px-4"
                                    onClick={() =>
                                        handleChannel(channel, "selected")
                                    }
                                >
                                    Add
                                </button>
